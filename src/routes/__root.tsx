    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="mx-auto flex h-36 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link to="/" className="flex items-center gap-2">
          <img src={umegolvLogo.url} alt="UmeGolv" className="h-30 w-auto" />
        </Link>
...
function MobileNav() {
  ...
  return (
    <div className="md:hidden">
      ...
      {open && (
        <div className="absolute left-0 right-0 top-36 border-b border-border bg-background px-4 py-4 shadow-sm">

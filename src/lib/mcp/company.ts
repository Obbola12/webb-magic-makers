export const company = {
  name: "UmeGolv",
  site: "umegolv.se",
  tagline: "Slipning, lackning och läggning av trägolv i Umeå med omnejd",
...
export const processSteps = [
  ...
  { step: "02", name: "Offert", description: "Efter besiktningen får du en tydlig, kostnadsfri offert utan dolda avgifter." },
  { step: "03", name: "Utförande", description: "Vi bokar in arbetet och genomför det med noggrannhet och respekt för ditt hem." },
  { step: "04", name: "Färdigställande", description: "Tillsammans går vi igenom resultatet och ser till att du är nöjd." },
];
